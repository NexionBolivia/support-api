...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Support.API.Services.Models.Profile", b =>
                {
                    b.Property<int>("IdProfile")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Support.API.Services.Models.SupportApiUser", b =>
                {
            ...
            modelBuilder.Entity("Support.API.Services.Models.SupportApiUser_UserKobo", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Support.API.Services.Models.UserKobo", b =>
                {
                    b.Property<string>("Name")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Support.API.Services.Models.Organization", b =>
                {
                    b.HasOne("Support.API.Services.Models.Profile", "Profile")
            ...
            modelBuilder.Entity("Support.API.Services.Models.SupportApiUser_UserKobo", b =>
                {
                    b.HasOne("Support.API.Services.Models.UserKobo", "UserKobo")
                        .WithMany("SupportApiUser_UserKobo")
                        .HasForeignKey("Name")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Support.API.Services.Models.SupportApiUser", "SupportApiUser")
                        .WithMany("SupportApiUser_UserKobo")
